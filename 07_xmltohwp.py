...
with open("C:/Users/rootsj/Desktop/hiconcy/static/json_to_xml2.xml",'r', encoding="UTF-8") as f:
    xml2 = f.read()


hwp.SetTextFile(xml2, "HWPML2X", "")
hwp.SaveAs("C:/Users/rootsj/Desktop/hiconcy/static/xml_to_hwp5.hwp","HWPML2X","")
